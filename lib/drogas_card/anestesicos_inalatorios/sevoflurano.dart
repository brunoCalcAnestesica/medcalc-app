...
class MedicamentoSevoflurano {
  ...
  static Widget buildCard(BuildContext context, Set<String> favoritos, void Function(String) onToggleFavorito) {
    ...
    return buildMedicamentoExpansivel(
      ...
      conteudo: _buildCardSevoflurano(context, peso, isAdulto, faixaEtaria),
    );
  }

  static Widget _buildCardSevoflurano(BuildContext context, double peso, bool isAdulto, String faixaEtaria) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const SizedBox(height: 16),
        const Text('Sevoflurano', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
