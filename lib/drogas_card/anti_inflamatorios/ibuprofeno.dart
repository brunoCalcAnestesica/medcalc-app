...
class Ibuprofeno {
  static Future<Widget> buildCard(BuildContext context) async {
    return FutureBuilder<String>(
      future: rootBundle.loadString('assets/medicamentos/ibuprofeno.json'),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return const Card(
            child: ListTile(
              leading: CircularProgressIndicator(),
              title: Text('Carregando Ibuprofeno...'),
            ),
          );
        }
        ...
        if (snapshot.hasError || !snapshot.hasData) {
          return const Card(
            child: ListTile(
              ...
              title: Text('Erro ao carregar Ibuprofeno'),
            ),
          );
        }
        ...
        try {
          ...
          final String nome = data['nome'] ?? 'Ibuprofeno';
