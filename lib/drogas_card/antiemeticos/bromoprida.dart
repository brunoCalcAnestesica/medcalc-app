...
class MedicamentoBromoprida {
  ...
  static Future<Map<String, dynamic>> carregarBulario() async {
    try {
      ...
      print('Erro ao carregar bulário do bromoprida: $e');
      return {};
    }
  }
  ...
  static Widget buildCard(BuildContext context, Set<String> favoritos, void Function(String) onToggleFavorito) {
    ...
    return buildMedicamentoExpansivel(
      ...
      conteudo: _buildConteudoBromoprida(context, peso, isAdulto),
    );
  }

  static Widget _buildConteudoBromoprida(BuildContext context, double peso, bool isAdulto) {
    return Column(
      ...
      children: [
        ...
        _linhaInfo('Nome comercial', 'Digesan®, Plamet®, Bromoprida®'),
        ...
        if (isAdulto) ...[
          ...
          _linhaIndicacaoDoseCalculada(
            ...
            descricaoDose: '10mg VO ou IV 3x/dia',
            unidade: 'mg',
            doseMaxima: 10,
            peso: peso,
          ),
        ...
        _textoObs('• Pode causar sonolência e efeitos extrapiramidais'),
        _textoObs('• Contraindicado em obstrução intestinal mecânica'),
        _textoObs('• Contraindicado em feocromocitoma'),
        ...
        const SizedBox(height: 8),
        _textoObs('• Hipersensibilidade ao bromoprida'),
