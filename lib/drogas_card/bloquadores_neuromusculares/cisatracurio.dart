...
class MedicamentoCisatracurio {
  ...
  static Future<Map<String, dynamic>> carregarBulario() async {
    try {
      ...
      print('Erro ao carregar bulário do cisatracúrio: $e');
      return {};
    }
  }
  ...
  static Widget buildCard(BuildContext context, Set<String> favoritos, void Function(String) onToggleFavorito) {
    ...
    return buildMedicamentoExpansivel(
      ...
      conteudo: _buildConteudoCisatracurio(context, peso, isAdulto),
    );
  }

  static Widget _buildConteudoCisatracurio(BuildContext context, double peso, bool isAdulto) {
    return Column(
      ...
      children: [
        ...
        _linhaInfo('Nome comercial', 'Nimbex®, Cisatracúrio®'),
        ...
        _linhaInfo('Duração', 'Intermediária (45-60 min)'),
        ...
        _linhaIndicacaoDoseCalculada(
          ...
          descricaoDose: '0,03 mg/kg IV a cada 20–30 min',
          unidade: 'mg',
          dosePorKg: 0.03,
          peso: peso,
        ),
        _linhaIndicacaoDoseCalculada(
          ...
          descricaoDose: '0,15 mg/kg IV inicial + manutenção',
          unidade: 'mg',
          dosePorKg: 0.15,
          peso: peso,
        ),
        ...
        _textoObs('• Ideal para pacientes com disfunção orgânica'),
        ...
        _linhaInfo('Duração', '45–60 minutos'),
        _linhaInfo('Metabolização', 'Degradação de Hofmann'),
        _linhaInfo('Meia-vida', '22–29 minutos'),

        // Contraindicações
        const SizedBox(height: 16),
        const Text('Contraindicações', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        const SizedBox(height: 8),
        _textoObs('• Hipersensibilidade ao cisatracúrio'),
        ...
        _textoObs('Incomuns (0,1–1%): Reações alérgicas leves'),
