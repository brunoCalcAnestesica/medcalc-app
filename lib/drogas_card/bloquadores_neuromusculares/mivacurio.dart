...
class MedicamentoMivacurio {
  ...
  static Future<Map<String, dynamic>> carregarBulario() async {
    try {
      final String jsonStr = await rootBundle.loadString('assets/medicamentos/mivacurio.json');
      final Map<String, dynamic> jsonMap = json.decode(jsonStr);
      return jsonMap['PT']['bulario'];
    } catch (e) {
      print('Erro ao carregar bulário do mivacúrio: $e');
      return {};
    }
  }
  ...
  static Widget buildCard(BuildContext context, Set<String> favoritos, void Function(String) onToggleFavorito) {
    ...
    return buildMedicamentoExpansivel(
      ...
      conteudo: _buildConteudoMivacurio(context, peso, isAdulto),
    );
  }

  static Widget _buildConteudoMivacurio(BuildContext context, double peso, bool isAdulto) {
    return Column(
      ...
      children: [
        ...
        _linhaInfo('Nome comercial', 'Mivacron®, Mivacúrio®'),
        ...
        _linhaInfo('Duração', 'Ultracurta (15-20 min)'),

        // Apresentações
        const SizedBox(height: 16),
        const Text('Apresentações', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        const SizedBox(height: 8),
        _linhaInfo('Frasco 2mg/mL', '10mL = 20mg'),
        ...
        const SizedBox(height: 8),
        _linhaInfo('Bolus', 'IV lenta (20–30s)'),
        ...
        _linhaIndicacaoDoseCalculada(
          titulo: 'Manutenção de bloqueio (infusão)',
        ...
        _linhaIndicacaoDoseCalculada(
          titulo: 'Procedimentos curtos',
          descricaoDose: '0,2 mg/kg IV, dose única',
          unidade: 'mg',
          dosePorKg: 0.2,
          peso: peso,
        ),
        _linhaIndicacaoDoseCalculada(
          ...
          descricaoDose: '0,1 mg/kg IV a cada 15 min',
          unidade: 'mg',
          dosePorKg: 0.1,
          peso: peso,
        ),
        ...
        _textoObs('• Não requer reversão na maioria dos casos'),
        _textoObs('• Monitorar função hepática'),
        _textoObs('• Cuidado em deficiência de colinesterase'),
        ...
        _linhaInfo('Duração', '15–20 minutos'),
        ...
        _textoObs('• Hipersensibilidade ao mivacúrio'),
