...
class MedicamentoRocuronio {
  ...
  static Future<Map<String, dynamic>> carregarBulario() async {
    try {
      ...
      print('Erro ao carregar bulário do rocurônio: $e');
      return {};
    }
  }
  ...
  static Widget buildCard(BuildContext context, Set<String> favoritos, void Function(String) onToggleFavorito) {
    ...
    return buildMedicamentoExpansivel(
      ...
      conteudo: _buildConteudoRocuronio(context, peso, isAdulto),
    );
  }

  static Widget _buildConteudoRocuronio(BuildContext context, double peso, bool isAdulto) {
    return Column(
      ...
      children: [
        ...
        _linhaInfo('Nome comercial', 'Esmeron®, Rocuron®, Rocurônio®'),
        ...
        const SizedBox(height: 8),
        _linhaInfo('Frasco 10mg/mL', '10mL = 100mg'),
        ...
        const SizedBox(height: 8),
        _linhaInfo('Bolus', 'IV direta (intubação)'),
        ...
        _linhaIndicacaoDoseCalculada(
          ...
          descricaoDose: '0,6 mg/kg IV lenta',
          unidade: 'mg',
          dosePorKg: 0.6,
          peso: peso,
        ),
        ...
        _linhaIndicacaoDoseCalculada(
          ...
          descricaoDose: '0,15 mg/kg IV a cada 15–20 min',
          unidade: 'mg',
          dosePorKg: 0.15,
          peso: peso,
        ),
        ...
        _textoObs('• Início de ação rápido (1-2 min)'),
        ...
        _linhaInfo('Eliminação', 'Renal (30%)'),

        // Contraindicações
        const SizedBox(height: 16),
        const Text('Contraindicações', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        const SizedBox(height: 8),
        _textoObs('• Hipersensibilidade ao rocurônio'),
        ...
        _textoObs('• Antagonizado por Sugamadex'),
