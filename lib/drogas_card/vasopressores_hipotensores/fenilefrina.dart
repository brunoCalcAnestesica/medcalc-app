...
Widget _buildCardFenilefrina(
  ...
  return Column(
    ...
    children: [
      ...
      const Text('Fenilefrina', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
      ...
      _linhaPreparo('10mg em 10mL SF 0,9%', 'Push dose: 1 mg/mL'),
      ...
      const SizedBox(height: 8),
      _textoObs('• Metabolização hepática e intestinal por MAO.'),
      _textoObs('• Excreção renal como metabólitos inativos.'),
      _textoObs('• Duração de ação curta (5–20 minutos).'),
      _textoObs('• Início de ação IV imediato (<1 minuto).'),
    ],
  );
}
...
class MedicamentoFenilefrina {
  ...
  static Future<Map<String, dynamic>> carregarBulario() async {
    final String jsonStr = await rootBundle.loadString('assets/medicamentos/fenilefrina.json');
